...
from util.molrepr import SmolMol, SmolBatch, GeometricMol, GeometricMolBatch
...
class GeometricInterpolant(Interpolant):
    ...
    def interpolate(self, to_mols: List[GeometricMol]) -> _GeometricInterpT:
        ...
        # NOTE: An ugly hack to make sure the property is not lost during interpolation
        for from_mol, to_mol, interp_mol in zip(from_mols, to_mols, interp_mols):
            interp_mol.property = to_mol.property
            interp_mol.property_name = to_mol.property_name 
            from_mol.property = to_mol.property
            from_mol.property_name = to_mol.property_name
