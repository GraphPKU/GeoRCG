...
save_dir=/home/lizian/GeoRCG/EDM_based/unimol_log/unimol_drug_6layers # replace to your save path
...
python -m torch.distributed.run --nproc_per_node=$n_gpu --master_port=$MASTER_PORT $(which unicore-train) $data_path  --user-dir $user_dir --train-subset train --valid-subset valid \
       ...
       --save-dir $save_dir  --only-polar $only_polar --data_ligands $data_ligands --encoder-layers $encoder_layers 