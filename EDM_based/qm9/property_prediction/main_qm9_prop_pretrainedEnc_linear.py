...
import pickle
from models_GeoRCG.encoders import initialize_encoder, get_global_representation
import numpy as np
loss_l1 = nn.L1Loss()
    ...
    if args.model_name == 'egnn':
        ...
        class Encoder_Linear(nn.Module):
            ...
            def forward(self, h0, x, edges, edge_attr, node_mask, edge_mask, n_nodes):
                ...
                rep = get_global_representation(node_mask, self.encoder, x, h0, noise_sigma=0., device=None)
