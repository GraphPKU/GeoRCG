...
from GeoRCG_models.rdm.models.diffusion.ddim import DDIMSampler as BaseDDIMSampler
import torch
...
from GeoRCG_models.sde.sde_sampling import get_pc_sampler, AncestralSamplingPredictor, LangevinCorrector
from GeoRCG_models.sde.sde_lib import VPSDE
...
class GtSampler(BaseRepSampler):
    ...
    def sample_(
        ...
        rep = get_global_representation(node_mask, self.encoder, pos, z, device=device)
...
def initilize_rep_sampler(rep_sampler_args, device, dataset_args=None, debug=False, num_layers=None):
    ...
    if rep_sampler_args.sampler == "GtSampler":
        ...
        from GeoRCG_models.util import misc
